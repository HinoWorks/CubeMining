...
public class EffectManager : MonoBehaviour
{
    ...
    [SerializeField] GameObject pf_eff_blockConvert;
    ...
    private List<GameObject> pool_eff_blockConvert = new List<GameObject>();
    ...
    private int createCountInit_blockConvert = 10;
    ...
    void Start()
    {
        ...
        for (int i = 0; i < createCountInit_blockConvert; i++)
        {
            var newUnit = Instantiate(pf_eff_blockConvert, InGameManager.Inst.ParentPool) as GameObject;
            newUnit.SetActive(false);
            pool_eff_blockConvert.Add(newUnit);
        }
    ...
    private (GameObject, List<GameObject>) Get_EffectData(EffectType _effectType)
    {
        switch (_effectType)
        {
            ...
            case EffectType.BlockConvert:
                return (pf_eff_blockConvert, pool_eff_blockConvert);
